...
def get_mix_price(stock_symbol='NaN'):
    ...
    if current_price == 'error symbol':
        return 'error symbol'
    elif current_price == 'connect timeout':
        return 'connect timeout'
    elif type(current_price) == dict:
        return 'simular_symbol'+'\n'+str(current_price)

    max_price = get_max_price(stock_symbol)
